"""Summarize audio experiment results into a CSV table."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Summarize audio LoRA experiment results.")
...
def main() -> None:
    ...
    if not df.empty:
        ...
        with markdown_path.open("w", encoding="utf-8") as f:
            ...
            f.write("# Audio LoRA Result Table\n\n")
            ...
            for _, row in df.iterrows():
                ...
                for header in headers:
                    ...
                    if header in {"accuracy", "eval_loss"} and pd.notna(value):
